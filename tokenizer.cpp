...
enum KeyToken{
    ...
    IF, ELSE, FOR, WHILE, CASE, SWITCH, BREAK, DEFAULT, RET, PRINT, PRINTLN,//Done
...
map<string, KeyToken> keywords = {
    ...
    {"IF", IF}, {"ELSE", ELSE}, {"FOR", FOR}, {"WHILE", WHILE}, {"CASE", CASE}, {"SWITCH", SWITCH}, {"BREAK", BREAK}, {"DEFAULT", DEFAULT}, {"RETURN", RET}, {"PRINT",PRINT}, {"PRINTLN", PRINTLN},
...
string keytokens[] {
    ...
    "IF","ELSE","FOR","WHILE","CASE","SWITCH", "BREAK", "DEFAULT", "RET", "PRINT", "PRINTLN",
