...
enum KeyToken{
    ...
    CONST, SINGULAR, VOLATILE, PUBLIC, PRIVATE, PROTECTED, OPERATOR, //Done
...
map<string, KeyToken> keywords = {
    ...
    {"const", CONST}, {"singular", SINGULAR}, {"volatile", VOLATILE}, {"public", PUBLIC}, {"private", PRIVATE}, {"protected", PROTECTED}, {"operator", OPERATOR},
...
string keytokens[] {
    ...
    "CONST","SINGULAR", "VOLATILE", "PUBLIC","PRIVATE","PROTECTED","OPERATOR",
    "SCONST", "NUMCONST",
